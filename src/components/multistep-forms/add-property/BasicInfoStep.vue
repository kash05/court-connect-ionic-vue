        ...
        <div class="form-fields">
            ...
            <IonItem class="form-item ion-no-padding">
                <div class="w-full">
                    ...
                    <IonNote class="helper-text">
                        Brief description of your property (minimum 10
                        characters)
                    </IonNote>
                    <IonTextarea
                        ...
                        :rows="4"
                        :class="{
                            valid: description && !hasFieldError('description'),
                        }"
                    />
            ...
            <IonItem class="form-item ion-no-padding">
                <div class="w-full">
                    ...
                    <IonNote class="helper-text"
                        >Property location address</IonNote
                    >
                    <IonInput
                        type="text"
            ...
            <IonItem class="form-item ion-no-padding">
                <div class="w-full">
                    ...
                    <IonInput
                        ...
                        :class="{
                            valid:
                                contactPhone && !hasFieldError('contactPhone'),
                        }"
                    />
                    <IonText
                        color="danger"
            ...
            <IonItem class="form-item ion-no-padding">
                <div class="w-full">
                    ...
                    <IonInput
                        ...
                        :class="{
                            valid:
                                contactEmail && !hasFieldError('contactEmail'),
                        }"
                    />
                    <IonText
                        color="danger"
