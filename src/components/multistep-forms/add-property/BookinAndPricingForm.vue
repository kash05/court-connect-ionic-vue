            ...
            <IonCardContent>
                <IonItem class="form-item ion-no-padding">
                    <div class="w-full">
                        ...
                        <IonNote class="helper-text"
                            >Hours before booking when cancellation is
                            free</IonNote
                        >
                        <IonInput
                            type="number"
                ...
                <IonItem class="form-item ion-no-padding">
                    <div class="w-full">
                        ...
                        <IonNote class="helper-text"
                            >Percentage of booking fee charged for late
                            cancellation</IonNote
                        >
                        <IonInput
                            type="number"
                            placeholder="50"
                ...
                <IonItem class="form-item ion-no-padding">
                    <div class="w-full">
                        ...
                        <IonNote class="helper-text"
                            >Fixed charge for customers who don't show
                            up</IonNote
                        >
                        <IonInput
                            type="number"
