        ...
        <IonContent>
            <div class="page-container">
                    ...
                    <div class="grid grid-cols-3 gap-3 mt-4">
                        ...
                        >
                            <div class="text-center">
                                <p class="text-xs text-[var(--ion-color-dark)]">
                                    Yesterday
                                </p>
                                <p
                                    class="text-lg font-semibold text-[var(--ion-color-dark)]"
                                >
                                    ₹{{
                ...
                <div class="mb-6">
                                ...
                                <div class="flex-1 p-4">
                                    ...
                                    >
                                        <div class="flex-1">
                                            ...
                                            <p
                                                class="text-xs text-[var(--ion-color-medium)] mb-2"
                                            >
                                                {{ property.type }}
                                            </p>
                                            ...
                                            >
                                                ...
                                                <div class="flex items-center">
                                                    <span
                                                        class="text-xs text-yellow-600 mr-1"
                                                        >⭐
                                                        {{
                                                            property.rating
                                                        }}</span
                    ...
                    <div
                        v-if="properties.length > 3 && !showAllProperties"
                        class="mt-4"
                    >
                        <IonButton
                            expand="block"
